...
} from "@/lib/projects/project-background";
import {
  formatRootProjectCode,
  nextChildCode,
} from "@/lib/projects/project-code";
import { inferKind, isPreviewableImage, mimeFromFilename } from "@/lib/vault/kinds";
import { tagsForAssets, tagsForFolders, assignRequiredKindTag, setAssetTags } from "@/lib/tags/tags";
import { isKindTagKey } from "@/lib/tags/tag-utils";
import type {
  AssetDTO,
  AssetKind,
  FolderDTO,
